...
| ⑧ +展平N个batch(9→3 barriers) | 20.2 | 7.3 | 6.4 | 6.0 | 6.1 | 1.67x |
...
| Case | Shape | ④ t16 | ⑦ t16 | ⑦ 改善 | oneDNN t16 | vs oneDNN |
|------|-------|--------|--------|--------|-----------|-----------|
| 0 | 4,192,40,40 | 7.0 | 7.3 | +0.3 ↑ | 3.55 | 2.06x 慢 |
| 1 | 4,96,80,80 | 5.9 | 6.2 | +0.3 ↑ | 4.22 | 1.47x 慢 |
| 2 | 4,48,160,160 | 10.6 | 10.4 | -0.2 | 4.06 | 2.56x 慢 |
| 3 | 4,192,20,20 | 2.3 | 1.2 | **-1.1** | 2.83 | **0.42x ✓快58%** |
| 4 | 4,384,80,80 | 8.2 | 6.8 | **-1.4** | 13.78 | **0.50x ✓快50%** |
| 5 | 4,768,40,40 | 6.3 | 4.6 | **-1.7** | 9.09 | **0.51x ✓快49%** |

### 阶段⑦ vs ⑥（确认合并修复了回退）

| Case | ⑥ t32 | ⑦ t32 | 变化 | 说明 |
|------|--------|--------|------|------|
| 0 | 7.2 | 7.0 | -0.2 ✓恢复 | 从回退中恢复 |
| 1 | 6.3 | 5.6 | -0.7 ✓恢复 | 从回退中恢复 |
| 2 | 8.7 | 8.8 | +0.1 ≈持平 | — |
| 3 | 1.0 | 1.0 | 0 ✓保持 | 保留⑥改善 |
| 4 | 5.1 | 5.0 | -0.1 ✓保持 | 保留⑥改善 |
| 5 | 4.0 | 3.6 | -0.4 ✓更好 | 进一步改善 |

### 阶段⑦ t32 vs oneDNN（全部 case）

| Case | Shape | ⑦ t32 | oneDNN t32(估) | 结果 |
|------|-------|--------|-------------|------|
| 0 | 4,192,40,40 | 7.0 | 3.6 | 慢 1.94x |
| 1 | 4,96,80,80 | 5.6 | ~3.5 | 慢 ~1.6x |
| 2 | 4,48,160,160 | 8.8 | ~3.0 | 慢 ~2.9x |
| 3 | 4,192,20,20 | 1.0 | ~2.5 | **快 ~2.5x** ✓ |
| 4 | 4,384,80,80 | 5.0 | ~12 | **快 ~2.4x** ✓ |
| 5 | 4,768,40,40 | 3.6 | ~8 | **快 ~2.2x** ✓ |

**Case 3/4/5 在 32 线程时已大幅超越 oneDNN**（快 2.2-2.5x）。
